...
public class StockTaskService extends GcmTaskService {
  ...
  public int onRunTask(TaskParams params) {
    ...
    if (params.getTag().equals(mContext.getResources().getString(R.string.init)) || params.getTag().equals(mContext.getResources().getString(R.string.periodic))){
      isUpdate = true;
      ...
      String stockInput = params.getExtras().getString(mContext.getResources().getString(R.string.str_symbol));
      try {
