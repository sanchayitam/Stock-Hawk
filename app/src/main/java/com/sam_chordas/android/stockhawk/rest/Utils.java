  ...
  public static ArrayList quoteJsonToContentVals(String JSON){
    ...
    try{
      ...
      if (jsonObject != null && jsonObject.length() != 0) {
       ...
       //   Log.i("JSON",jsonObject.getString(KEY_RESULTS));
          if (jsonObject.getString(KEY_CHANGE) != null && jsonObject.getString(KEY_CHANGE)!= "null") {
            ContentProviderOperation oper = buildBatchOperation(jsonObject);
            if (oper != null) {
              batchOperations.add(oper);
            }
        }
        } else {
